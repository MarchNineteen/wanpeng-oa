package net.zdsoft.wanpeng.config;
...
public interface UserAgent {
    ...
    String MOBILE_FOR_IPHONE = "iPhone10,3(iOS/14.5) Uninview(Uninview/1.0.0) Weex/0.26.0 1125x2436";

    String X_ZDSOFT_AGENT = "x-zdsoft-agent";
    String X_ZDSOFT_AGENT_VALUE = "mobile";
}
